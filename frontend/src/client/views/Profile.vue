        ...
        <b-card title="Edit Profile">
            <b-row>
                ...
                <b-col md="6">
                    ...
                    >
                        <x-tag-input :value="form.client_type"
                                   resource="/client/api/search/client_types" column="title" name="title"
                                   @input="onClientTypeUpdated">
                        </x-tag-input>
                        <error :error="error.client_type_id"/>
                    </b-form-group>
                </b-col>
                ...
                <b-col md="6">
                    ...
                    >
                        <x-tag-input :value="form.country"
                                     resource="/client/api/search/countries" column="title" name="title"
                ...
                <b-col md="6">
                    ...
                    >
                        <x-tag-input :value="form.state" :params="{country_id: form.country_id}"
                                     resource="/client/api/search/states" column="title" name="title"
                ...
                <b-col md="6">
                    ...
                    >
                        <x-tag-input :value="form.city" :params="{state_id: form.state_id}"
                                     resource="/client/api/search/cities" column="title" name="title"
                                     @input="onCityUpdated">
                        </x-tag-input>
                ...
                <b-col md="6" class="mb-2">
                    <template v-if="form.old_photo !== null">
                        <b-img thumbnail fluid width="100" :src="`/client/api/attachment/client_profile/${form.old_photo}`" />
                    </template>
                </b-col>
                <b-col cols="12">
                    <hr>
...
<script>
    ...
    export default {
        ...
        created() {
            get('/client/api/get_detail').then(res => {
                if (res.data) {
                    this.setData(res)
                }
            })
        ...
        methods: {
            ...
            onClientTypeUpdated(e){
                Vue.set(this.$data.form,'client_type',e);
                Vue.set(this.$data.form,'client_type_id',e.id);
            },
            onCountryUpdated(e){
