        ...
        <div class="content-body">
            <div class="auth-wrapper auth-cover">
                <div class="auth-inner row m-0">
                    <!-- Brand logo--><a class="brand-logo" href="/client"
                        ...
                        <h2 class="brand-text text-primary ms-1">{{config('app.name')}} Client Register</h2></a>
                    <!-- /Brand logo-->
                {{--                    <!-- Left Text-->--}}
                        ...
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <form class="auth-register-form mt-2" action="{{ route('client.register') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-1">
                                        <label class="form-label" for="client_type_id">ARE YOU A</label>
                                        <select class="form-control" id="client_type_id" name="client_type_id">
                                            <option value="">Select</option>
                                            @foreach($client_types as $row)
                                                <option
                                                    value="{{$row->id}}" {{ old('client_type_id') == $row->id ? 'selected' : '' }}>{{$row->title}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <p class="text-center mt-2"><span>Already have an account?</span><a
                                    href="/client/login"><span>&nbsp;Sign in instead</span></a></p>
                        </div>
                    </div>
                    <!-- /Register-->
                </div>
