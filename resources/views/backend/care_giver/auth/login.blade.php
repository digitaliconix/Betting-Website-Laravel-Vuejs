            ...
            <div class="auth-wrapper auth-cover">
                <div class="auth-inner row m-0">
                    <!-- Brand logo--><a class="brand-logo" href="/care_giver">
                        ...
                        <h2 class="brand-text text-primary ms-1">{{config('app.name')}} CareGiver</h2></a>
                    <!-- /Brand logo-->
                    <!-- Left Text-->
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <form class="auth-login-form mt-2" action="{{ route('care_giver.login') }}" method="post">
                                {{ csrf_field() }}
                                <div class="mb-1">
                            ...
                            <p class="text-center mt-2"><span>New on our platform?</span><a href="/care_giver/register"><span>&nbsp;Create an account</span></a>
                            </p>
