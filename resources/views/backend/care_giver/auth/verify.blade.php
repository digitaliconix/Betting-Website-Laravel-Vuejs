...
<head>
    ...
    <title>Verify Email Basic - {{config('app.name')}} - Bootstrap HTML admin template</title>
        ...
        <div class="content-body">
            <div class="auth-wrapper auth-basic px-2">
                <div class="auth-inner my-2">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="/care_giver" class="brand-logo">
                                <svg
                                    viewbox="0 0 139 95"
                                    version="1.1"
                            ...
                            <a href="/care_giver/logout" class="btn btn-primary w-100">Skip for now</a>
